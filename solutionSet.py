...
def trade(give, receive):
    ...
    if not own(give):
        print("You can't trade away something you don't own!")
        print("Directly to jail!")
    elif own(receive):
        print("You already have one of those. Don't bother trading for another one.")
    else:
        collection.add(receive)
        collection.remove(give)
        print("Trade successful! " + give + " removed and " + receive + " added!")
